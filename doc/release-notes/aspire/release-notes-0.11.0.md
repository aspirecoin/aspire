...
- Reduced lower nitrosend limit to 1.5 DRK
...
- Added more detailed Nitrosend status information to Overview tab
- Added Nitrosend high precision matching engine
- Added Nitrosend balance to `getinfo`
